...
const HOW_IT_WORKS = [
  {
    step: "01",
    title: "Artists submit or get featured",
    body: "Independent artists submit their music directly or get handpicked by our curators. Every track earns its place — no pay-to-play, no shortcuts.",
    accent: "#00e5ff",
  },
  {
    step: "02",
